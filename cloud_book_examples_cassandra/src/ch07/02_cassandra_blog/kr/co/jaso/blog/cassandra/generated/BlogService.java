...
public class BlogService {
  ...
  public interface Iface extends kr.co.jaso.blog.cassandra.generated.ApplicationService.Iface {
  ...
  public interface AsyncIface extends kr.co.jaso.blog.cassandra.generated.ApplicationService .AsyncIface {
    ...
    public void searchBlogByKeyword(String userId, String keyword, AsyncMethodCallback<AsyncClient.searchBlogByKeyword_call> resultHandler) throws TException;

  }

  public static class Client extends kr.co.jaso.blog.cassandra.generated.ApplicationService.Client implements TServiceClient, Iface {
    ...
    public List<BlogArticle> searchBlogByKeyword(String userId, String keyword) throws BlogException, TException
    {
      send_searchBlogByKeyword(userId, keyword);
      return recv_searchBlogByKeyword();
    }

    public void send_searchBlogByKeyword(String userId, String keyword) throws TException
    {
      oprot_.writeMessageBegin(new TMessage("searchBlogByKeyword", TMessageType.CALL, ++seqid_));
      searchBlogByKeyword_args args = new searchBlogByKeyword_args();
      args.setUserId(userId);
    ...
    public List<BlogArticle> recv_searchBlogByKeyword() throws BlogException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "searchBlogByKeyword failed: out of sequence response");
      }
      searchBlogByKeyword_result result = new searchBlogByKeyword_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.isSetSuccess()) {
        return result.success;
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "searchBlogByKeyword failed: unknown result");
    }

  }
  public static class AsyncClient extends kr.co.jaso.blog.cassandra.generated.ApplicationService.AsyncClient implements AsyncIface {
    ...
    public void searchBlogByKeyword(String userId, String keyword, AsyncMethodCallback<searchBlogByKeyword_call> resultHandler) throws TException {
      checkReady();
      searchBlogByKeyword_call method_call = new searchBlogByKeyword_call(userId, keyword, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class searchBlogByKeyword_call extends TAsyncMethodCall {
      private String userId;
      private String keyword;
      public searchBlogByKeyword_call(String userId, String keyword, AsyncMethodCallback<searchBlogByKeyword_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
      ...
      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("searchBlogByKeyword", TMessageType.CALL, 0));
        searchBlogByKeyword_args args = new searchBlogByKeyword_args();
        args.setUserId(userId);
        args.setKeyword(keyword);
        args.write(prot);
      ...
      public List<BlogArticle> getResult() throws BlogException, TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_searchBlogByKeyword();
      }
    }

  }

  public static class Processor extends kr.co.jaso.blog.cassandra.generated.ApplicationService.Processor implements TProcessor {
    ...
    public Processor(Iface iface)
    {
      ...
      processMap_.put("searchBlogByKeyword", new searchBlogByKeyword());
    }
    ...
    private class searchBlogByKeyword implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        searchBlogByKeyword_args args = new searchBlogByKeyword_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("searchBlogByKeyword", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        searchBlogByKeyword_result result = new searchBlogByKeyword_result();
        try {
          result.success = iface_.searchBlogByKeyword(args.userId, args.keyword);
        } catch (BlogException be) {
          result.be = be;
        } catch (Throwable th) {
          LOGGER.error("Internal error processing searchBlogByKeyword", th);
          TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing searchBlogByKeyword");
          oprot.writeMessageBegin(new TMessage("searchBlogByKeyword", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
        ...
        oprot.writeMessageBegin(new TMessage("searchBlogByKeyword", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
  ...
  public static class saveBlog_args implements TBase<saveBlog_args, saveBlog_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(saveBlog_args other) {
      ...
      if (isSetArticle()) {        lastComparison = TBaseHelper.compareTo(this.article, typedOther.article);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
  ...
  public static class searchBlogByUserId_args implements TBase<searchBlogByUserId_args, searchBlogByUserId_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    @Deprecated
    public searchBlogByUserId_args clone() {
      return new searchBlogByUserId_args(this);
    }
  ...
  public static class searchBlogByUserId_result implements TBase<searchBlogByUserId_result, searchBlogByUserId_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    @Deprecated
    public searchBlogByUserId_result clone() {
      return new searchBlogByUserId_result(this);
    }
  ...
  public static class searchBlogByKeyword_args implements TBase<searchBlogByKeyword_args, searchBlogByKeyword_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("searchBlogByKeyword_args");

    private static final TField USER_ID_FIELD_DESC = new TField("userId", TType.STRING, (short)1);
    private static final TField KEYWORD_FIELD_DESC = new TField("keyword", TType.STRING, (short)2);
    ...
    static {
      ...
      tmpMap.put(_Fields.USER_ID, new FieldMetaData("userId", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRING)));
      tmpMap.put(_Fields.KEYWORD, new FieldMetaData("keyword", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(searchBlogByKeyword_args.class, metaDataMap);
    }

    public searchBlogByKeyword_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public searchBlogByKeyword_args(searchBlogByKeyword_args other) {
      if (other.isSetUserId()) {
        this.userId = other.userId;
      }
    ...
    public searchBlogByKeyword_args deepCopy() {
      return new searchBlogByKeyword_args(this);
    }

    @Deprecated
    public searchBlogByKeyword_args clone() {
      return new searchBlogByKeyword_args(this);
    }
    ...
    public searchBlogByKeyword_args setUserId(String userId) {
      this.userId = userId;
      return this;
    }
    ...
    public searchBlogByKeyword_args setKeyword(String keyword) {
      this.keyword = keyword;
      return this;
    }
    ...
    /** Returns true if field keyword is set (has been asigned a value) and false otherwise */
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof searchBlogByKeyword_args)
        return this.equals((searchBlogByKeyword_args)that);
      return false;
    }

    public boolean equals(searchBlogByKeyword_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(searchBlogByKeyword_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      searchBlogByKeyword_args typedOther = (searchBlogByKeyword_args)other;
      ...
      if (isSetKeyword()) {        lastComparison = TBaseHelper.compareTo(this.keyword, typedOther.keyword);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.keyword != null) {
        ...
        oprot.writeString(this.keyword);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("searchBlogByKeyword_args(");
      boolean first = true;
  ...
  public static class searchBlogByKeyword_result implements TBase<searchBlogByKeyword_result, searchBlogByKeyword_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("searchBlogByKeyword_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.BE, new FieldMetaData("be", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(searchBlogByKeyword_result.class, metaDataMap);
    }

    public searchBlogByKeyword_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public searchBlogByKeyword_result(searchBlogByKeyword_result other) {
      if (other.isSetSuccess()) {
        List<BlogArticle> __this__success = new ArrayList<BlogArticle>();
        for (BlogArticle other_element : other.success) {
          __this__success.add(new BlogArticle(other_element));
    ...
    public searchBlogByKeyword_result deepCopy() {
      return new searchBlogByKeyword_result(this);
    }

    @Deprecated
    public searchBlogByKeyword_result clone() {
      return new searchBlogByKeyword_result(this);
    }
    ...
    public searchBlogByKeyword_result setSuccess(List<BlogArticle> success) {
      this.success = success;
      return this;
    }
    ...
    public searchBlogByKeyword_result setBe(BlogException be) {
      this.be = be;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof searchBlogByKeyword_result)
        return this.equals((searchBlogByKeyword_result)that);
      return false;
    }

    public boolean equals(searchBlogByKeyword_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(searchBlogByKeyword_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      searchBlogByKeyword_result typedOther = (searchBlogByKeyword_result)other;
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<BlogArticle>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  BlogArticle _elem10;
                  _elem10 = new BlogArticle();
                  _elem10.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (BlogArticle _iter11 : this.success)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("searchBlogByKeyword_result(");
      boolean first = true;
